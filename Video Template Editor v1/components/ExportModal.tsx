...
export function ExportModal({ project, onExport }: ExportModalProps) {
  ...
  const getTotalDuration = () => {
    if (!hasVideos) return 0;
    return project.videos.reduce((acc, video) => 
      acc + (video.position.endTime - video.position.startTime), 0
    );
  };
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            {hasVideos 
              ...
              : 'Add videos to your timeline to start exporting your project.'
            }
          </DialogDescription>
        </DialogHeader>
        ...
        {!hasVideos && !isExporting && !exportComplete && !exportError && (
          <div className="space-y-6 text-center py-8">
            ...
            <div className="space-y-2">
              <h4>No Videos in Timeline</h4>
              <p className="text-sm text-muted-foreground">
                Your project doesn't have any videos on the timeline yet. Upload and add videos to get started with exporting.
              </p>
            </div>

            <div className="space-y-3">
              <div className="bg-muted/50 p-4 rounded-lg text-left">
                <h5 className="text-sm mb-2">How to add videos:</h5>
                <ol className="text-xs text-muted-foreground space-y-1 list-decimal list-inside">
                  <li>Upload a video using the left sidebar</li>
                  <li>Drag the video to the timeline at the bottom</li>
        ...
        {/* Settings Screen - Only show when videos exist */}
        {hasVideos && !isExporting && !exportComplete && !exportError && (
        ...
        {exportComplete && (
          <div className="space-y-6 text-center">
            ...
            <div>
              ...
              <div className="mt-3 p-3 bg-green-50 rounded-lg border border-green-200">
                <p className="text-sm text-green-800">
                  <strong>File:</strong> {project.name}.{settings.format}
                </p>
                <p className="text-sm text-green-800">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foregrund">
